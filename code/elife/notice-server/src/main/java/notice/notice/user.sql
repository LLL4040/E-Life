...
insert into `community`(id,communityname,communityinfo,manager,password,phone,email,`address`,`account`)value (1,'九天花园','九天花园小区','二郎神','123','188808','123@qq.com','hahaha','hhh' );


INSERT INTO `user`(`username`,`password`,`phone`,`email`,`role`,`community_id`)value ('哪吒','123','1088558','10@qq.com',0,1);
INSERT INTO `user`(`username`,`password`,`phone`,`email`,`role`,`community_id`)value ('悟能','123','1088558','10@qq.com',0,1);

INSERT INTO `user`(`username`,`password`,`phone`,`email`,`role`,`community_id`)value ('二郎神','123','10888','10@qq.com',1,1);
INSERT INTO `user`(`username`,`password`,`phone`,`email`,`role`,`community_id`)value ('哮天犬','123','1088778','104@qq.com',0,1);
INSERT INTO `manager`(`username`,`password`,`phone`,`email`,`role`,`community_id`)value ('二郎神','123','1088778','104@qq.com',0,1);
