...
class payCenter extends State<pay>
...
//        elevation: 15.0, //设置阴影
        ...
        child: new Column(
          ...
          children: [
            ListTile(
                leading:
                    bill.status == -1 || bill.status == 1 || bill.status == 11
                ...
                subtitle: new Column(
                  ...
                  children: <Widget>[
                    ...
                    OutlineButton(
                        ...
                        onPressed: () {
                          print(bill.id);
                          getOrderInfo(bill.id.toString(), bill.bill.toString(),
                              bill.time.toString());
                        }),
                    OutlineButton(
                        child: Text("支付"),
...
//    myrepairs.add(myrepair);
  ...
  getOrderInfo(String id, String bill, String time) async {
    ...
    await manager.pay(
        this, order.id.toString(), order.bill.toString(), order.time);
  }
