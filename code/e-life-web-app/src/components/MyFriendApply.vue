<template>
  <div>
    <div align="center">
      <el-input v-model="search" size="medium" style="width: 400px" suffix-icon="el-icon-search" placeholder="输入状态关键字搜索，如：已通过、未通过、未处理"/>
    </div>
    <el-row :gutter="10" style="padding-top: 20px">
      <el-col :span="12">
        <el-card class="box-card">
          ...
          <el-table :data="my.filter(data => !search || data.status.toLowerCase().includes(search.toLowerCase()))" style="width: 100%">
